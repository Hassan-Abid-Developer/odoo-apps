...
from odoo.custom_addons.l10n_pk_hr_payroll.tests.common import TestPaymentAdviceBase
...
class TestPaymentAdvice(TestPaymentAdviceBase):
    ...
    def test_00_payment_advice_flow(self):
        ...
        test_reports.try_report(self.cr, self.uid, 'l10n_pk_hr_payroll.report_payrolladvice', payment_advice.ids)
